...
our $VERSION = substr q$Revision: 1.56 $, 10;
...
our %strrep = (
    ...
    '(\d)(st|nd|rd|th)' => q/"$1"/,          # 1st, 2nd, 3rd, 4th, etc.
    'ninth' => q/"nine"/,                    # avoids C<runnin => ru9> bug
    );
...
$Id: Numericalize.pm,v 1.56 2003/09/16 20:33:25 ekkis Exp $
